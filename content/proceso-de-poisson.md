...
**Proceso de Poisson** es una entrada troncal de no equilibrio dentro de la mecanica estadistica. Su papel principal es describir modelo de eventos aleatorios independientes en tiempo continuo. Esta pagina resume la definicion operativa, las ecuaciones minimas y las conexiones con otros conceptos de la wiki.
