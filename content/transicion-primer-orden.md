...
**Transicion de primer orden** es una entrada troncal de transiciones y criticalidad dentro de la mecanica estadistica. Su papel principal es describir transicion con discontinuidad en una derivada primera del potencial. Esta pagina resume la definicion operativa, las ecuaciones minimas y las conexiones con otros conceptos de la wiki.
