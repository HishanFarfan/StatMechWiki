...
**Balance detallado** es una entrada troncal de metodos dentro de la mecanica estadistica. Su papel principal es describir condicion suficiente para que una cadena de Markov tenga una distribucion estacionaria deseada. Esta pagina resume la definicion operativa, las ecuaciones minimas y las conexiones con otros conceptos de la wiki.
