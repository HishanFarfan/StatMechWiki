...
**Modelo de Potts** es una entrada troncal de modelos dentro de la mecanica estadistica. Su papel principal es describir generalizacion del modelo de Ising con q estados por sitio. Esta pagina resume la definicion operativa, las ecuaciones minimas y las conexiones con otros conceptos de la wiki.
