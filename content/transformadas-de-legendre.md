...
**Transformadas de Legendre** es una entrada troncal de termodinamica estadistica dentro de la mecanica estadistica. Su papel principal es describir cambio de variables naturales entre potenciales termodinamicos. Esta pagina resume la definicion operativa, las ecuaciones minimas y las conexiones con otros conceptos de la wiki.
