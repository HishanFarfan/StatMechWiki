...
**Distribucion de Boltzmann** es una entrada troncal de ensambles dentro de la mecanica estadistica. Su papel principal es describir peso exponencial que favorece estados de menor energia. Esta pagina resume la definicion operativa, las ecuaciones minimas y las conexiones con otros conceptos de la wiki.
