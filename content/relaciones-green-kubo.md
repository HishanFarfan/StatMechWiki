...
**Relaciones de Green-Kubo** es una entrada troncal de no equilibrio dentro de la mecanica estadistica. Su papel principal es describir expresiones de coeficientes de transporte en terminos de correlaciones de equilibrio. Esta pagina resume la definicion operativa, las ecuaciones minimas y las conexiones con otros conceptos de la wiki.
