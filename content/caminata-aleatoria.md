...
**Caminata aleatoria** es una entrada troncal de modelos dentro de la mecanica estadistica. Su papel principal es describir modelo probabilistico basico para difusion y polimeros ideales. Esta pagina resume la definicion operativa, las ecuaciones minimas y las conexiones con otros conceptos de la wiki.
