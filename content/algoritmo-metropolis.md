...
**Algoritmo de Metropolis** es una entrada troncal de metodos dentro de la mecanica estadistica. Su papel principal es describir regla de aceptacion que muestrea la distribucion de Boltzmann. Esta pagina resume la definicion operativa, las ecuaciones minimas y las conexiones con otros conceptos de la wiki.
