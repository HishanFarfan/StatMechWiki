...
**Distribucion de Maxwell-Boltzmann** es una entrada troncal de ensambles dentro de la mecanica estadistica. Su papel principal es describir distribucion clasica de velocidades en equilibrio. Esta pagina resume la definicion operativa, las ecuaciones minimas y las conexiones con otros conceptos de la wiki.
