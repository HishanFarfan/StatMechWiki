...
Una ampliacion futura deberia partir de transicion con discontinuidad en una derivada primera del potencial y mostrar un caso donde esa idea cambie el calculo, la interpretacion o el diagnostico. Si el material nuevo solo repite el resumen general de **Transiciones y criticalidad**, conviene moverlo a una pagina troncal.
