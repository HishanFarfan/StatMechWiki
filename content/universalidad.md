...
**Universalidad** es una entrada troncal de transiciones y criticalidad dentro de la mecanica estadistica. Su papel principal es describir independencia de exponentes criticos respecto de detalles microscopicos. Esta pagina resume la definicion operativa, las ecuaciones minimas y las conexiones con otros conceptos de la wiki.
