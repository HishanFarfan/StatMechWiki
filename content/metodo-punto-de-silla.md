...
**Metodo de punto de silla** es una entrada troncal de metodos dentro de la mecanica estadistica. Su papel principal es describir aproximacion asintotica para integrales dominadas por un extremo. Esta pagina resume la definicion operativa, las ecuaciones minimas y las conexiones con otros conceptos de la wiki.
