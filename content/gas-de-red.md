...
**Gas de red** es una entrada troncal de modelos dentro de la mecanica estadistica. Su papel principal es describir modelo de ocupacion discreta equivalente al Ising bajo cambio de variables. Esta pagina resume la definicion operativa, las ecuaciones minimas y las conexiones con otros conceptos de la wiki.
