...
**Densidad de estados** es una entrada troncal de fundamentos dentro de la mecanica estadistica. Su papel principal es describir numero de estados disponibles por intervalo de energia. Esta pagina resume la definicion operativa, las ecuaciones minimas y las conexiones con otros conceptos de la wiki.
