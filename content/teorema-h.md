...
**Teorema H** es una entrada troncal de no equilibrio dentro de la mecanica estadistica. Su papel principal es describir resultado de Boltzmann que conecta dinamica cinetica con aumento de entropia. Esta pagina resume la definicion operativa, las ecuaciones minimas y las conexiones con otros conceptos de la wiki.
