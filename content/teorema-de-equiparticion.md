...
**Teorema de equiparticion** es una entrada troncal de fundamentos dentro de la mecanica estadistica. Su papel principal es describir aporte energetico medio de terminos cuadraticos clasicos. Esta pagina resume la definicion operativa, las ecuaciones minimas y las conexiones con otros conceptos de la wiki.
