...
**Ruptura espontanea de simetria** es una entrada troncal de transiciones y criticalidad dentro de la mecanica estadistica. Su papel principal es describir seleccion de un estado de equilibrio que no comparte la simetria del Hamiltoniano. Esta pagina resume la definicion operativa, las ecuaciones minimas y las conexiones con otros conceptos de la wiki.
