...
**Transicion continua** es una entrada troncal de transiciones y criticalidad dentro de la mecanica estadistica. Su papel principal es describir transicion sin calor latente pero con divergencias de respuesta. Esta pagina resume la definicion operativa, las ecuaciones minimas y las conexiones con otros conceptos de la wiki.
