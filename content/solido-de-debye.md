...
**Solido de Debye** es una entrada troncal de modelos dentro de la mecanica estadistica. Su papel principal es describir modelo de fonones con espectro continuo hasta una frecuencia de corte. Esta pagina resume la definicion operativa, las ecuaciones minimas y las conexiones con otros conceptos de la wiki.
