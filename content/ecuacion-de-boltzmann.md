...
**Ecuacion de Boltzmann** es una entrada troncal de no equilibrio dentro de la mecanica estadistica. Su papel principal es describir ecuacion cinetica para la distribucion de una particula. Esta pagina resume la definicion operativa, las ecuaciones minimas y las conexiones con otros conceptos de la wiki.
