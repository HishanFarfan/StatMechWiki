...
**Expansion virial** es una entrada troncal de modelos dentro de la mecanica estadistica. Su papel principal es describir correccion sistematica a la ecuacion de gas ideal en potencias de densidad. Esta pagina resume la definicion operativa, las ecuaciones minimas y las conexiones con otros conceptos de la wiki.
