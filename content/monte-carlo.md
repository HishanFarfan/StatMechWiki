...
**Monte Carlo** es una entrada troncal de metodos dentro de la mecanica estadistica. Su papel principal es describir familia de metodos de muestreo estocastico de configuraciones. Esta pagina resume la definicion operativa, las ecuaciones minimas y las conexiones con otros conceptos de la wiki.
