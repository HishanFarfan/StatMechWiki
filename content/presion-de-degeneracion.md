...
**Presion de degeneracion** es una entrada troncal de cuantica dentro de la mecanica estadistica. Su papel principal es describir presion de origen cuantico debida al llenado de estados fermionicos. Esta pagina resume la definicion operativa, las ecuaciones minimas y las conexiones con otros conceptos de la wiki.
