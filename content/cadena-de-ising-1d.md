...
**Cadena de Ising 1D** es una entrada troncal de modelos dentro de la mecanica estadistica. Su papel principal es describir modelo de Ising en una dimension, soluble por matriz de transferencia. Esta pagina resume la definicion operativa, las ecuaciones minimas y las conexiones con otros conceptos de la wiki.
