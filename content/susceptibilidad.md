...
**Susceptibilidad** es una entrada troncal de termodinamica estadistica dentro de la mecanica estadistica. Su papel principal es describir respuesta de un parametro de orden ante su campo conjugado. Esta pagina resume la definicion operativa, las ecuaciones minimas y las conexiones con otros conceptos de la wiki.
