...
Fuera del equilibrio, **Corriente estacionaria** describe evolucion, transporte o respuesta cuando no basta una distribucion de Gibbs estatica. Decir que flujo persistente de probabilidad, particulas, energia o carga en un estado estacionario indica que variable temporal, corriente o tasa entra en juego.
