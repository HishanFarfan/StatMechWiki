...
**Escalamiento de tamano finito** es una entrada troncal de transiciones y criticalidad dentro de la mecanica estadistica. Su papel principal es describir metodo para extraer criticalidad desde sistemas finitos. Esta pagina resume la definicion operativa, las ecuaciones minimas y las conexiones con otros conceptos de la wiki.
