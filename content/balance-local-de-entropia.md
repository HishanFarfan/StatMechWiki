...
Fuera del equilibrio, **Balance local de entropia** describe evolucion, transporte o respuesta cuando no basta una distribucion de Gibbs estatica. Decir que ecuacion que separa cambio local de entropia, flujo de entropia y produccion interna indica que variable temporal, corriente o tasa entra en juego.
