...
Como metodo, **Monte Carlo** es un procedimiento para calcular o aproximar propiedades estadisticas. La afirmacion de que familia de metodos de muestreo estocastico de configuraciones indica que problema computacional o analitico intenta resolver.
