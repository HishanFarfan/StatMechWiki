...
**Red de Bethe** es una entrada troncal de modelos dentro de la mecanica estadistica. Su papel principal es describir red tipo arbol que permite soluciones recursivas de modelos estadisticos. Esta pagina resume la definicion operativa, las ecuaciones minimas y las conexiones con otros conceptos de la wiki.
