...
**Ecuacion maestra** es una entrada troncal de no equilibrio dentro de la mecanica estadistica. Su papel principal es describir evolucion temporal de probabilidades entre estados discretos. Esta pagina resume la definicion operativa, las ecuaciones minimas y las conexiones con otros conceptos de la wiki.
