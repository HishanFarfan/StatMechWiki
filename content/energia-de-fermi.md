...
**Energia de Fermi** es una entrada troncal de cuantica dentro de la mecanica estadistica. Su papel principal es describir energia del nivel ocupado mas alto a temperatura cero. Esta pagina resume la definicion operativa, las ecuaciones minimas y las conexiones con otros conceptos de la wiki.
