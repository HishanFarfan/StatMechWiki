...
**Numeros de ocupacion** es una entrada troncal de cuantica dentro de la mecanica estadistica. Su papel principal es describir descripcion de sistemas cuanticos indistinguibles por ocupaciones de modos. Esta pagina resume la definicion operativa, las ecuaciones minimas y las conexiones con otros conceptos de la wiki.
