...
**Susceptibilidad critica** es una entrada troncal de transiciones y criticalidad dentro de la mecanica estadistica. Su papel principal es describir respuesta divergente cerca de una transicion continua. Esta pagina resume la definicion operativa, las ecuaciones minimas y las conexiones con otros conceptos de la wiki.
