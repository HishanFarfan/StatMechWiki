...
**Metodo de histogramas** es una entrada troncal de metodos dentro de la mecanica estadistica. Su papel principal es describir tecnica para reponderar observables a temperaturas cercanas. Esta pagina resume la definicion operativa, las ecuaciones minimas y las conexiones con otros conceptos de la wiki.
