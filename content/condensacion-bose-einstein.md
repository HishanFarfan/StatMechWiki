...
**Condensacion de Bose-Einstein** es una entrada troncal de cuantica dentro de la mecanica estadistica. Su papel principal es describir ocupacion macroscopica del estado fundamental por bosones. Esta pagina resume la definicion operativa, las ecuaciones minimas y las conexiones con otros conceptos de la wiki.
