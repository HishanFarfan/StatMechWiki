...
**Gas ideal cuantico** es una entrada troncal de modelos dentro de la mecanica estadistica. Su papel principal es describir gas de particulas indistinguibles donde importan ocupaciones cuanticas. Esta pagina resume la definicion operativa, las ecuaciones minimas y las conexiones con otros conceptos de la wiki.
