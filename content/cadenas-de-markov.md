...
**Cadenas de Markov** es una entrada troncal de metodos dentro de la mecanica estadistica. Su papel principal es describir procesos estocasticos donde el futuro depende solo del estado presente. Esta pagina resume la definicion operativa, las ecuaciones minimas y las conexiones con otros conceptos de la wiki.
