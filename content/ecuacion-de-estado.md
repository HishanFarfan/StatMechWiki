...
**Ecuacion de estado** es una entrada troncal de termodinamica estadistica dentro de la mecanica estadistica. Su papel principal es describir relacion macroscopica entre variables termodinamicas. Esta pagina resume la definicion operativa, las ecuaciones minimas y las conexiones con otros conceptos de la wiki.
