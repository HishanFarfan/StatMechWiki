...
**Matriz de transferencia** es una entrada troncal de metodos dentro de la mecanica estadistica. Su papel principal es describir metodo para reescribir funciones de particion como trazas de matrices. Esta pagina resume la definicion operativa, las ecuaciones minimas y las conexiones con otros conceptos de la wiki.
