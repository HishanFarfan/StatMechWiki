...
**Energia libre de Gibbs** es una entrada troncal de termodinamica estadistica dentro de la mecanica estadistica. Su papel principal es describir potencial natural para temperatura, presion y numero de particulas fijos. Esta pagina resume la definicion operativa, las ecuaciones minimas y las conexiones con otros conceptos de la wiki.
