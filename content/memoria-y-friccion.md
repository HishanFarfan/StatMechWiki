...
Fuera del equilibrio, **Memoria y friccion** describe evolucion, transporte o respuesta cuando no basta una distribucion de Gibbs estatica. Decir que descripcion de disipacion no local en el tiempo mediante kernels de friccion indica que variable temporal, corriente o tasa entra en juego.
