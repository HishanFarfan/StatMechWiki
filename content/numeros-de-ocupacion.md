...
Estos ejemplos son deliberadamente pequenos: muestran como usar **Numeros de ocupacion** sin introducir un modelo mas complicado que el necesario.
...
2. **Limite clasico.** Si $e^{\beta(\epsilon-\mu)}\gg1$, Bose-Einstein y Fermi-Dirac se aproximan a Maxwell-Boltzmann. Este caso simple muestra cuando Numeros de ocupacion puede reemplazarse por una descripcion clasica.
3. **Escala de degeneracion.** En un gas diluido, $n\lambda_T^3\ll1$ indica comportamiento casi clasico. Cuando esa cantidad se acerca a uno, descripcion de sistemas cuanticos indistinguibles por ocupaciones de modos deja de ser una correccion menor y cambia las ocupaciones observables.
...
Dentro del mapa general, **Numeros de ocupacion** queda reservado para la idea precisa de descripcion de sistemas cuanticos indistinguibles por ocupaciones de modos. Su papel local es incorporar indistinguibilidad, niveles discretos y ocupaciones de modos. Esta funcion editorial evita repetir el mismo formalismo en todas las entradas: aqui se conserva solo la parte necesaria para reconocer el objeto, aplicar su ecuacion principal y decidir con que paginas conviene compararlo.

$$
\hat H,\ \hat N\longrightarrow \hat\rho\longrightarrow \langle \hat A\rangle
$$

Una ampliacion futura deberia partir de descripcion de sistemas cuanticos indistinguibles por ocupaciones de modos y mostrar un caso donde esa idea cambie el calculo, la interpretacion o el diagnostico. Si el material nuevo solo repite el resumen general de **Cuantica**, conviene moverlo a una pagina troncal.
