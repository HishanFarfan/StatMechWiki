...
**Aproximacion de campo medio** es una entrada troncal de metodos dentro de la mecanica estadistica. Su papel principal es describir sustitucion de interacciones locales por un campo efectivo promedio. Esta pagina resume la definicion operativa, las ecuaciones minimas y las conexiones con otros conceptos de la wiki.
