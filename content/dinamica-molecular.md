...
**Dinamica molecular** es una entrada troncal de metodos dentro de la mecanica estadistica. Su papel principal es describir integracion numerica de ecuaciones de movimiento microscopicas. Esta pagina resume la definicion operativa, las ecuaciones minimas y las conexiones con otros conceptos de la wiki.
