...
**Clase de universalidad de Ising** es una entrada troncal de transiciones y criticalidad dentro de la mecanica estadistica. Su papel principal es describir familia de sistemas con parametro de orden escalar y simetria Z2. Esta pagina resume la definicion operativa, las ecuaciones minimas y las conexiones con otros conceptos de la wiki.
