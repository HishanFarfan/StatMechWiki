...
**Reservorio termico** es una entrada troncal de ensambles dentro de la mecanica estadistica. Su papel principal es describir sistema grande que fija la temperatura de un sistema pequeno. Esta pagina resume la definicion operativa, las ecuaciones minimas y las conexiones con otros conceptos de la wiki.
