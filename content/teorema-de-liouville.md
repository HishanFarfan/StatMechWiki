...
**Teorema de Liouville** es una entrada troncal de fundamentos dentro de la mecanica estadistica. Su papel principal es describir conservacion de volumen de espacio de fases bajo dinamica hamiltoniana. Esta pagina resume la definicion operativa, las ecuaciones minimas y las conexiones con otros conceptos de la wiki.
