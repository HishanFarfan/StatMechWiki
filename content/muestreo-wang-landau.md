...
**Muestreo de Wang-Landau** es una entrada troncal de metodos dentro de la mecanica estadistica. Su papel principal es describir metodo para estimar densidades de estados mediante caminata en energia. Esta pagina resume la definicion operativa, las ecuaciones minimas y las conexiones con otros conceptos de la wiki.
