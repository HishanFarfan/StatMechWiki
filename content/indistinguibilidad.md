...
**Indistinguibilidad** es una entrada troncal de fundamentos dentro de la mecanica estadistica. Su papel principal es describir principio por el cual permutar particulas identicas no genera un estado fisico nuevo. Esta pagina resume la definicion operativa, las ecuaciones minimas y las conexiones con otros conceptos de la wiki.
