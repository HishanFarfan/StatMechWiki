...
<figure style="margin:2em 0"><img src="./assets/figures/entropia-spines.svg" alt="Grafica de S(E) para N espines de dos niveles mostrando temperatura positiva, infinita y negativa" style="max-width:500px;width:100%;display:block;margin:0 auto"><figcaption style="text-align:center;font-size:0.88em;color:#666;margin-top:0.5em">Figura 1. Entropia de Boltzmann S(E) para N espines de dos niveles. La pendiente 1/T = (&#x2202;S/&#x2202;E)<sub>V,N</sub> define la temperatura: positiva donde S crece, cero en el maximo (T &#x2192; &#xB1;&#x221E;), negativa donde S decrece. La region T &lt; 0 es inaccesible para el ensamble canonico con T &gt; 0.</figcaption></figure>
